...
## (branch) Master vs Dev ##
  ...
  1. ####  Master branch is related with first part of the test. Go to next topic (Deployment)! After finishing this step checkout to dev branch and start from deploying topic!
